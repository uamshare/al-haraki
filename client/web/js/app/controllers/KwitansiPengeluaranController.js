	        ...
	        var exportTo = {
	            xls : function(gridApi){
	                function download(id){
	                    ...
	                    console.log(table);
	                    var ctx = { worksheet : name || 'Rekap_Pengeluaran ' + postfix, table : table.innerHTML }
	                    
	                    var a = document.createElement('a');
	                    a.href = uri + base64(format(template, ctx));
	                    a.download = 'rekap_pengeluaran_' + postfix + '.xls';
	                    a.click();
	                    // return false;
	                }
	            ...
	            _title : 'Rekap Pengeluaran ' + authService.getSekolahProfile().nama_sekolah,
	            ...
	            function setTableData(obj){
	                ...
	                for(var idx in rows){
	                    ...
	                    rowbody.push({
                            ...
                            nama_penerima : rowdata.nama_penerima,
