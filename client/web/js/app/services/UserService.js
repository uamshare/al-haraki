...
define(['app'], function (app) {
    ...
    var UserService = function ($http, $q) {
        ...
        factory.getProfile = function () {
            return $http.get(serviceBase + 'users/profile').then(function (results) {
                return results.data;
            });
        };

        factory.updateProfile = function (params) {
            return $http.post(serviceBase + 'users/profile', params).then(function (results) {
                return results.data;
            });
        };
